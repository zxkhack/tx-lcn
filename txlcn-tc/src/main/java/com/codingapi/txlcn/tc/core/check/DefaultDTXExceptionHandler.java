...
public class DefaultDTXExceptionHandler implements DTXExceptionHandler {
    ...
    public void handleJoinGroupBusinessException(Object params, Throwable ex) throws TransactionException {
        ...
        try {
            transactionCleanupTemplate.secondPhase(groupId, unitId, unitType, 0);
        } catch (TransactionClearException e) {
            txLogger.error(groupId, unitId, "join group", "secondPhase [{}]transaction fail.", unitType);
        }
        throw new TransactionException(ex);
    }
    ...
    public void handleNotifyGroupBusinessException(Object params, Throwable ex) {
        ...
        try {
            ...
            txLogger.error(groupId, unitId, "notify group", "{} > secondPhase transaction error.", transactionType);
        }
    }
    ...
    public void handleNotifyGroupMessageException(Object params, Throwable ex) {
        ...
        String transactionType = (String) paramList.get(3);
        try {
            transactionCleanupTemplate.secondPhaseWithoutAspectLog(groupId, unitId, transactionType, state);
        } catch (TransactionClearException e) {
            txLogger.error(groupId, unitId, "notify group", "{} > secondPhaseWithoutAspectLog transaction error.", transactionType);
        }
