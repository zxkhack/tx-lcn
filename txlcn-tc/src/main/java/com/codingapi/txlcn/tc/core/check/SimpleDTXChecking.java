...
public class SimpleDTXChecking implements DTXChecking, DisposableBean {
    ...
    private TransactionCleanupTemplate transactionCleanupTemplate;
    ...
    public void setTransactionCleanupTemplate(TransactionCleanupTemplate transactionCleanupTemplate) {
    ...
    public void startDelayCheckingAsync(String groupId, String unitId, String transactionType) {
        ...
        ScheduledFuture scheduledFuture = scheduledExecutorService.schedule(() -> {
            try {
                ...
                if (state == -1) {
                    txLogger.error(this.getClass().getSimpleName(), "delay secondPhase transaction error.");
                ...
                txLogger.error(this.getClass().getSimpleName(), "{} secondPhase transaction error.", transactionType);
            }
    ...
    private void onAskTransactionStateException(String groupId, String unitId, String transactionType) {
        try {
            ...
            // 事务回滚, 保留适当的补偿信息
            transactionCleanupTemplate.secondPhaseWithoutAspectLog(groupId, unitId, transactionType, 0);
        } catch (TransactionClearException e) {
            txLogger.error(groupId, unitId, Transactions.TAG_TASK, "{} > secondPhase transaction error.", transactionType);
        }
    }
