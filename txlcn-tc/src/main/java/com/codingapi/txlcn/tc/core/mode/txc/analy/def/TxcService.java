 ...
 */
package com.codingapi.txlcn.tc.core.mode.txc.analy.def;

import com.codingapi.txlcn.common.exception.TxcLogicException;
import com.codingapi.txlcn.tc.core.mode.txc.analy.def.bean.DeleteImageParams;
import com.codingapi.txlcn.tc.core.mode.txc.analy.def.bean.InsertImageParams;
import com.codingapi.txlcn.tc.core.mode.txc.analy.def.bean.SelectImageParams;
import com.codingapi.txlcn.tc.core.mode.txc.analy.def.bean.UpdateImageParams;
